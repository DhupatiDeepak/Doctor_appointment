...
const Login = () => {
  ...
  return (
    <div className="min-h-[90vh] flex items-center justify-center bg-[#FBFCFF] px-4 font-['Outfit',sans-serif]">
        ...
        <div className="bg-white p-10 md:p-12 rounded-[40px] shadow-[0_20px_60px_-15px_rgba(15,23,42,0.1)] border border-gray-50 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-400 font-bold text-xs uppercase tracking-widest">Sign in to your dashboard</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {loading ? 'Signing in...' : 'Sign In'} <ArrowRight className="w-4 h-4 ml-3" />
              </button>
            </form>
